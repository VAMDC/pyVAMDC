...
to provide information about the query and its execution. They come from the list 
of metadata items providing query information suggested in \citep{ivoaDataOrigin} 
...
\begin{lstlisting}{language=XML}
<INFO name="last_update_date" value=""/>
\end{lstlisting}
